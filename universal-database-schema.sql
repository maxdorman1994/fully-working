-- ============================================
-- A Wee Adventure - Universal Database Schema
-- ============================================
-- Works with any PostgreSQL database (Neon, Railway, PlanetScale, etc.)
...
DO $$
BEGIN
    RAISE NOTICE '🏴󠁧󠁢󠁳󠁣󠁴󠁿 A Wee Adventure - Universal Database Schema Installed Successfully!';
    RAISE NOTICE '';
