-- Clean Milestones System Database Schema
-- Creates tables for milestone tracking, progress, and achievements WITHOUT fake completed milestones
...
-- Insert all 50 milestones (all start as locked/available)
...
-- Starting Milestones (Available immediately)
('first-adventure', 'First Adventure', 'Record your first journal entry to start your Scottish exploration journey', 'exploration', 'MapPin', 100, '{"color": "from-blue-500 to-indigo-600", "bgColor": "from-blue-50 to-indigo-100", "borderColor": "border-blue-200/60"}', 'simple', NULL, NULL, NULL, 1),
('photo-memories', 'Photo Memories', 'Upload your first photos to capture Scottish memories', 'photography', 'Camera', 75, '{"color": "from-purple-500 to-violet-600", "bgColor": "from-purple-50 to-violet-100", "borderColor": "border-purple-200/60"}', 'simple', NULL, NULL, NULL, 2),
('family-adventure', 'Family Adventure', 'Include family members in your first adventure', 'family', 'Heart', 125, '{"color": "from-pink-500 to-rose-600", "bgColor": "from-pink-50 to-rose-100", "borderColor": "border-pink-200/60"}', 'simple', NULL, NULL, NULL, 3),
('first-journal', 'First Journal Entry', 'Write your first adventure story', 'documentation', 'Eye', 50, '{"color": "from-green-500 to-emerald-600", "bgColor": "from-green-50 to-emerald-100", "borderColor": "border-green-200/60"}', 'simple', NULL, NULL, NULL, 4),
('first-upload', 'Photo Uploader', 'Upload your first adventure photo', 'photography', 'Camera', 25, '{"color": "from-violet-500 to-purple-600", "bgColor": "from-violet-50 to-purple-100", "borderColor": "border-violet-200/60"}', 'simple', NULL, NULL, NULL, 5),
...
-- Locked Milestones (Require completion of other milestones first)
...
-- Success message
DO $$ BEGIN
  RAISE NOTICE '✅ Clean milestone system database schema created successfully!';
  RAISE NOTICE 'Created 50 milestones across 10 categories with NO fake completed milestones.';
  RAISE NOTICE 'All milestones start as locked/available and progress will be tracked from real journal entries.';
  RAISE NOTICE 'Use: SELECT * FROM milestones ORDER BY sort_order; to see all milestones.';
  RAISE NOTICE 'Use: SELECT * FROM user_milestone_progress WHERE user_id = ''demo-user''; to see actual progress.';
END $$;
