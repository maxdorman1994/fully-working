-- ============================================
-- A Wee Adventure - Supabase Database Schema
-- ============================================
...
-- Insert some sample Scottish adventure data
...
(
    ...
    ARRAY['https://imagedelivery.net/xOX5dmniuBba3n86-ZApZg/sample-ben-nevis/public']
),
(
    ...
    ARRAY['https://imagedelivery.net/xOX5dmniuBba3n86-ZApZg/sample-loch-lomond/public']
),
(
    ...
    ARRAY['https://imagedelivery.net/xOX5dmniuBba3n86-ZApZg/sample-edinburgh-castle/public']
);
...
DO $$
BEGIN
    RAISE NOTICE '🏴󠁧󠁢󠁳󠁣󠁴󠁿 Scottish Adventure Journal database schema created successfully!';
